...
At ingestion, NeuroFlow must not add overlapping counts, choose a preferred
provider, merge intervals, discard either record, or manufacture a daily total.
Once source evidence is flattened, its provenance cannot be recovered.
