...
// only write is the existing living-state transition, fired when the person
// taps Resume — which also clears the stale re-entry metadata.
//
...
class ReEntryCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final interrupted = ref.watch(interruptedTasksProvider).value;
